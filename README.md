...
Replace `https://github.com/Narek-Melkumyan/cinema-booking` with this repository's clone URL:

```bash
git clone <repository-url>](https://github.com/Narek-Melkumyan/cinema-booking cinema-booking
cd cinema-booking
npm install
```
